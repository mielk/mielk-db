...
import { Pool, ResultSetHeader, createConnection, createPool } from 'mysql2/promise';
...
const mockCreatePool: jest.MockedFunction<any> = (createPool as jest.MockedFunction<any>).mockResolvedValue({
	query: mockQuery,
});
